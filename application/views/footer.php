			...
			<div class="footer-info">
				<ul>
					...
					<li><a href="#"><?php echo Kohana::lang('ui_main.blog'); ?></a></li>
                                ...
                                <p>
                                    All information displayed on this website has been collected by the Kenya AIDS NGOs Consortium (KANCO). KANCO is committed to sharing information. If you wish to use information from this site, KANCO requests that you acknowledge its source.
                                </p>
