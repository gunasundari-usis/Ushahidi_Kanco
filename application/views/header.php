...
<head>
	...
	if ($allow_feed == 1) {
		echo "<link rel=\"alternate\" type=\"application/rss+xml\" href=\"http://" . url::base() . "/feed/\" title=\"RSS2\" />";
	}
	?>
		...
		<div id="header">
			...
			<ul id="menu">
				<li class="first"><a <?php if ($this_page == 'home') echo 'class="active"'; ?> href="<?php echo url::base() . "main" ?>"><?php echo Kohana::lang('ui_main.home'); ?></a></li>
                                ...
                                <li><a <?php if ($this_page == 'reports') echo 'class="active"'; ?> href="<?php echo url::base() . "blog/" ?>">Blog</a></li>
				<li><a <?php if ($this_page == 'reports_submit') echo 'class="active"'; ?> href="<?php echo url::base() . "reports/submit" ?>"><?php echo Kohana::lang('ui_main.submit'); ?></a></li>
                                ...
                                <li><a <?php if ($this_page == 'reports') echo 'class="active"'; ?> href="<?php echo url::base() . "blog/?page_id=7" ?>">FAQ</a></li>
                                <li><a <?php if ($this_page == 'reports') echo 'class="active"'; ?> href="<?php echo url::base() . "blog/?page_id=2" ?>">About Us</a></li>
