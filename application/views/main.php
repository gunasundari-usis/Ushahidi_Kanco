          ...
          <div class="big-map-block">
			...
			<div id="kanco_charts">
				<div class="slider-holder">
	              ...
	              <div id="graph" class="graph-holder"> The KANCO Map of AIDS and TB Service Organizations is an online directory
of KANCO member organizations. Member organizations are non-governmental
organizations (NGOs, both local and international), community based
organizations (CBOs), faith-based organizations (FBOs), private sector,
and academic/research institutions responding to or that have an interest
in HIV & AIDS and TB in Kenya. These organizations share KANCO’s vision of
a Kenyan society free of HIV & AIDS and TB.
</div>
			</div>
			<div id="kanco_categories">
				<div class="category">
					<strong class="title">Service Delivery Area Filter</strong>
					<div class="grey-box">
						<div class="grey-box-bg">
							<ul>
								<li><a class="active" id="cat_0" href="#"><div class="swatch" style="background-color:#<?php echo $default_map_all;?>"></div><div class="float:left">All Service Delivery Area</div></a></li>
								<?php
