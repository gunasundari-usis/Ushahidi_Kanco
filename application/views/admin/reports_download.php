			...
			<table class="data_points">
				...
				<tr>
					...
					<td><?php print form::checkbox('data_include[]', '3', TRUE); ?>Include Categories</td>
                                ...
                                <tr>
                                        <td colspan="2"><?php print form::checkbox('data_include[]','5',TRUE); ?>Include Longitude</td>
                                </tr>
                                <?php 
                                        $i= 1; 
                                ...
                                <tr>
                                                ...
                                                <td colspan="2"><?php print form::checkbox('custom_form_include[]',$i, TRUE); print $disp_custom_field['field_name'];?></td>
                                </tr>
                                <?php $i++; } ?>
