						...
						<div class="f-col-1">
							...
							<div class="row link-row">
								...
								<?php								
                        			...
                        			{
                        				// Retrieve Docs
                        				foreach($incident->doc as $doc ) 
                        				{
                                                                print "<div class=\"report_thumbs\" id=\"doc_". $doc->id ."\">";
                                                                if ($doc->doc_type == 1)
                        					{

                                                                    print "<a href=\"".url::base() . "media/uploads/docs/".$doc->doc_link."\" ><img src=\"" . url::base() . "media/uploads/docs/word_icon.jpg\" title=\"Click on image to download file\" alt=\"Click on image to download file\" /></a>";
                                                                } elseif( $doc->doc_type == 2 ) 
                                                                {
                                                                    print "<a href=\"".url::base() . "media/uploads/docs/".$doc->doc_link."\" ><img src=\"" . url::base() . "media/uploads/docs/pdf_icon.jpg\" title=\"Click on image to download file\" alt=\"Click on image to download file\" /></a>";                                                                }
                        					print "&nbsp;&nbsp;<a href=\"#\" onClick=\"deleteDoc('". $doc->id ."', 'doc_". $doc->id ."'); return false;\" >Delete</a>";
                        					print "</div>";
                        				}
                        			}
			                    ?>
